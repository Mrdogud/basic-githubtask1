...
public class KongaSignUpTest {
    ...
    public void startWebPage() throws InterruptedException {
        ...
        driver.findElement(xpath("//*[@id=\"nav-bar-fix\"]/div[1]/div/a/img"));
    ...
    public void positivelogin1() throws InterruptedException {
        ...
        driver.findElement(id("username")).sendKeys("cyndysworld2000@yahoo.co.uk");
        //7. Input valid password
        driver.findElement(id("password")).sendKeys("cinderella");
    ...
    public void pageLogout() throws InterruptedException {
        ...
        driver.findElement(xpath("//*[@id=\"nav-bar-fix\"]/div[1]/div/div/div[4]/div/a/span")).click();
        //Logout from the account
        driver.findElement(xpath("//*[@id=\"nav-bar-fix\"]/div[1]/div/div/div[4]/div/ul/li[7]/a")).click();
